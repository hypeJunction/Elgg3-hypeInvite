<?php
/**
 * PHPUnit bootstrap for hypeinvite (Elgg 4.x characterization suite).
 *
 * hypeinvite uses the 4.x lifecycle: elgg-plugin.php declares a Bootstrap
 * class extending DefaultPluginBootstrap, and most wiring (entities,
 * actions, routes, hooks, events) is declarative in elgg-plugin.php.
 */
